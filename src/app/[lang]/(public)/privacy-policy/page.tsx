...
function PrivacyPolicy() {
  // i18n对象保持不变
  const _i18n = {
    "title": <Trans>EmojiClick 隐私政策</Trans>,
    "effective_date": <Trans>生效日期：2024-12-12</Trans>,
    "overview": <Trans>概述</Trans>,
    "overview_description": t`EmojiClick 运营网站 https://emojis.click/ 并致力于保护您的隐私。本隐私政策概述了我们收集的信息类型、我们如何使用这些信息，以及我们采取哪些步骤确保您的个人信息被适当处理。`,
    ...
    "personal_data_description_4": <Trans>这些信息是为了在我们的 EmojiClick 导航站上处理订单而收集的。</Trans>,
    ...
    "data_sharing_description": <Trans>EmojiClick 尊重您的隐私。我们不会与任何第三方分享您的个人数据，除非为了处理您的订单或遵守法律要求。</Trans>,
